...
public class World {
	...
	public void render(Graphics g) {
		...
		if (MAP == 0) {
			...
			/*
			 * for (int i = 1; i < 10; i++) { for (int j = 0; j < 28; j++) { if (i == 5) {
			 * g.setColor(Color.yellow); g.drawLine(0 + (j * 50), TAM_UI + TAM_PASSEIO + (i
			 * * TAM_RUA) - 2, 20 + (j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) - 2);
			 * g.setColor(Color.yellow); g.drawLine(0 + (j * 50), TAM_UI + TAM_PASSEIO + (i
			 * * TAM_RUA) + 2, 20 + (j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) + 2);
			 * 
			 * } else { g.setColor(Color.white); g.drawLine(0 + (j * 50), TAM_UI +
			 * TAM_PASSEIO + (i * TAM_RUA), 5 + (j * 50), TAM_UI + TAM_PASSEIO + (i *
			 * TAM_RUA));
			 * 
			 * g.drawLine(2 + (j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) - 5, 2 + (j *
			 * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) + 5);
			 * 
			 * g.drawLine((j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) - 5, 4 + (j * 50),
			 * TAM_UI + TAM_PASSEIO + (i * TAM_RUA) + 5);
			 * 
			 * g.drawLine(6 + (j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) - 5, (j * 50) -
			 * 2, TAM_UI + TAM_PASSEIO + (i * TAM_RUA) + 5); } } }
			 */
		} else if (MAP == 2) {
			// OCEANO
			Game.spritesheet = new Spritesheet("/sprite3.png");
			/*
			 * g.drawImage(LOGO_AGUA, 0, TAM_UI + TAM_PASSEIO, Game.WIDTH * 4, (Game.HEIGHT
			 * * 4) - (TAM_UI + TAM_PASSEIO + TAM_FOOT + TAM_PASSEIO), null);
			 */
			g.setColor(Color.cyan);
			g.fillRect(0, TAM_UI + TAM_PASSEIO, Game.WIDTH * 4,
					(Game.HEIGHT * 4) - (TAM_UI + TAM_PASSEIO + TAM_FOOT + TAM_PASSEIO));
			/*
			 * for (int i = 1; i < 10; i++) { for (int j = 0; j < 28; j++) { if (i == 5) {
			 * g.setColor(Color.yellow); g.drawLine(0 + (j * 50), TAM_UI + TAM_PASSEIO + (i
			 * * TAM_RUA) - 2, 20 + (j * 50), TAM_UI + TAM_PASSEIO + (i * TAM_RUA) - 2);
