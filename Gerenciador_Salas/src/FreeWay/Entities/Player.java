...
public class Player implements Serializable {
	...
	public boolean isColliding() {
		for (int i = 0; i < Game.vehicles.size(); i++) {
			if (Game.vehicles.get(i).MAO == 1) {
				if (Game.vehicles.get(i).POS_X - 50 < dados.POS_X + 20
						&& Game.vehicles.get(i).POS_X - 50 + 43 > dados.POS_X + 20
						&& (80 + i * 59) + 10 < dados.POS_Y + 20 && (80 + i * 59) + 10 + 30 > dados.POS_Y + 20) {
					return true;
				}
			} else {
				if (1400 - (Game.vehicles.get(i).POS_X - 5) < dados.POS_X + 20
						&& 1400 - (Game.vehicles.get(i).POS_X - 5) + 45 > dados.POS_X + 20
						&& (80 + i * 59) + 10 < dados.POS_Y + 20 && (80 + i * 59) + 10 + 30 > dados.POS_Y + 20) {
					return true;
				}
			}
