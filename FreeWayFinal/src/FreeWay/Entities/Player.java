...
public class Player implements Serializable {
	...
	public void tick() {
		...
		if (isNear()) {
			...
			switch (aux) {
			case 0:
				Sound y = new Sound("C:\\Users\\igors\\Desktop\\TPREDS\\GIT\\FreeWayRede\\Gerenciador_Salas2.2\\res\\buzina1.wav"); // Chamando a classe aonde está o audio.
				break;
			case 1:
				Sound y2 = new Sound("C:\\Users\\igors\\Desktop\\TPREDS\\GIT\\FreeWayRede\\Gerenciador_Salas2.2\\res\\buzina2.wav"); // Chamando a classe aonde está o audio.
				break;
			case 2:
				Sound y3 = new Sound("C:\\Users\\igors\\Desktop\\TPREDS\\GIT\\FreeWayRede\\Gerenciador_Salas2.2\\res\\buzina3.wav"); // Chamando a classe aonde está o audio.
				break;
			}
		}
